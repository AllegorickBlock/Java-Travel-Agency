        ...
        try {
            ...
            this.thread = new NetworkCommunicationThread(osocket, new NetworkCommunicationThread.Listener() {
                ...
                public void lockTrip(int read) {
                    Platform.runLater(()->resumeController.lockTrip(read));
                }
                ...
                public void updateTrip(StepList trip, int index) {
                    Platform.runLater(()-> resumeController.updateTrip(trip,index));
                }

                @Override
                public void deleteTrip(StepList read, int index) {
                    Platform.runLater(()-> resumeController.deleteTrip(read,index));
                }
            });
