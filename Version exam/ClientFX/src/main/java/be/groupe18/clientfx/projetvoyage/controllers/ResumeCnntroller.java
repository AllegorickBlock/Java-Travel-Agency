...
public class ResumeCnntroller {
    ...
    public void updateTrip(StepList trip, int index) {
        System.out.println(trip.getNameTrip()+" +- "+index);
    ...
    public void deleteTrip(RemoveTrip trip) {
        tripList.removeToList(trip.getStepList());
        resumeController.removeTrip(trip.getIndex());
    }

    public void removeTrip(RemoveTrip trip) {
        tripList.removeToList(trip.getStepList());
        listener.removeTrip(trip.getStepList());
        resumeController.removeTrip(trip.getIndex());
    }

    public void updateClientNumber(int numberClient) {
        resumeController.updateNumberClient(numberClient);
    }
